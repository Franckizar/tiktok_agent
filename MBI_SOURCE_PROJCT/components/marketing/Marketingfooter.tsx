    ...
    <footer className="relative bg-[#0a0a0f] border-t border-[#ff6b35]/20 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-black text-white mb-4 flex items-center gap-2 text-sm">
              ...
              {['About Us', 'Services', 'Contact'].map((item) => (
                <li key={item}>
                  <Link 
                    ...
                    className="text-gray-400 hover:text-[#ff6b35] transition-colors relative group inline-block text-sm"
                  >
                    {item.toUpperCase()}
